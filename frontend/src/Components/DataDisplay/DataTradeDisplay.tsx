...
const TradeCard: React.FC<Props> = ({ trade }) => {
  ...
  if (date === null) {
    ...
    return (
        ...
        >
            <div className="text-sm text-jet dark:text-snow sm:text-md md:text-base trade-card-details flex flex-row align-center w-full border-2 justify-between p-2 px-3">
